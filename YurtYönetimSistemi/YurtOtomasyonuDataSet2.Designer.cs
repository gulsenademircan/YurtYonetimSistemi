...
namespace YurtYönetimSistemi {
    ...
    public partial class YurtOtomasyonuDataSet2 : global::System.Data.DataSet {
        ...
        public partial class OgrenciDataTable : global::System.Data.TypedTableBase<OgrenciRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OgrenciRow AddOgrenciRow(string OgrAd, string OgrSoyad, int OgrYillik) {
...
namespace YurtYönetimSistemi.YurtOtomasyonuDataSet2TableAdapters {
    ...
    public partial class OgrenciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ogrenci] ([OgrAd], [OgrSoyad], [OgrYillik]) VALUES (@OgrAd, @O" +
                "grSoyad, @OgrYillik);\r\nSELECT Ogrid, OgrAd, OgrSoyad, OgrYillik FROM Ogrenci WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Ogrenci] SET [OgrAd] = @OgrAd, [OgrSoyad] = @OgrSoyad, [OgrYillik] = @OgrYillik WHERE (([Ogrid] = @Original_Ogrid) AND ((@IsNull_OgrAd = 1 AND [OgrAd] IS NULL) OR ([OgrAd] = @Original_OgrAd)) AND ((@IsNull_OgrSoyad = 1 AND [OgrSoyad] IS NULL) OR ([OgrSoyad] = @Original_OgrSoyad)) AND ((@IsNull_OgrYillik = 1 AND [OgrYillik] IS NULL) OR ([OgrYillik] = @Original_OgrYillik)));
SELECT Ogrid, OgrAd, OgrSoyad, OgrYillik FROM Ogrenci WHERE (Ogrid = @Ogrid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Ogrid, OgrAd, OgrSoyad, OgrYillik FROM dbo.Ogrenci";
        ...
        public virtual int Delete(int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, global::System.Nullable<int> Original_OgrYillik) {
        ...
        public virtual int Insert(string OgrAd, string OgrSoyad, global::System.Nullable<int> OgrYillik) {
            if ((OgrAd == null)) {
        ...
        public virtual int Update(string OgrAd, string OgrSoyad, global::System.Nullable<int> OgrYillik, int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, global::System.Nullable<int> Original_OgrYillik, int Ogrid) {
            if ((OgrAd == null)) {
            ...
            if ((Original_OgrYillik.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_OgrYillik.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string OgrAd, string OgrSoyad, global::System.Nullable<int> OgrYillik, int Original_Ogrid, string Original_OgrAd, string Original_OgrSoyad, global::System.Nullable<int> Original_OgrYillik) {
            return this.Update(OgrAd, OgrSoyad, OgrYillik, Original_Ogrid, Original_OgrAd, Original_OgrSoyad, Original_OgrYillik, Original_Ogrid);
        }
    }
